...
public class TF2weapons {
    ...
    public void preinit(FMLPreInitializationEvent event) {
        ...
        CapabilityManager.INSTANCE.register(ItemFromData.AttributeProvider.class, new NullStorage<ItemFromData.AttributeProvider>(), () -> {
            return null;
        });
        ...
        cratesOpened = (new StatBasic("stat.cratesOpened", new TextComponentTranslation("stat.cratesOpened"))).registerStat();
        robotsKilled = (new StatBasic("stat.robotsKilled", new TextComponentTranslation("stat.cratesKilled"))).registerStat();
        ...
        BlockDispenser.DISPENSE_BEHAVIOR_REGISTRY.putObject(itemPlacer, new BehaviorDefaultDispenseItem() {
            ...
            public ItemStack dispenseStack(IBlockSource p_82487_1_, ItemStack p_82487_2_) {
                ...
                if (entity instanceof EntityLivingBase && p_82487_2_.hasDisplayName())
                    entity.setCustomNameTag(p_82487_2_.getDisplayName());
