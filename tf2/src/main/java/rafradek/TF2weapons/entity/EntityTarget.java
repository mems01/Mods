...
public class EntityTarget extends EntityArmorStand {
    ...
    private static final DataParameter<Float> LAST_DAMAGE = EntityDataManager.createKey(EntityTarget.class, DataSerializers.FLOAT);
    private static final DataParameter<Float> DPS = EntityDataManager.createKey(EntityTarget.class, DataSerializers.FLOAT);
